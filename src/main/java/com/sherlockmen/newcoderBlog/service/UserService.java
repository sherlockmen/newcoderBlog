...
import com.sherlockmen.newcoderBlog.util.MailClient;
import org.apache.commons.lang3.StringUtils;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.beans.factory.annotation.Value;
import org.springframework.stereotype.Service;
import org.thymeleaf.TemplateEngine;
import com.sherlockmen.newcoderBlog.util.*;
...
@Service
public class UserService implements NewCoderBlogConstant{
    ...
    @Value("${newcoderBlog.path.domain}")
    ...
    public Map<String, Object> register(User user){
        ...
        //注册用户
        user.setSalt(newcoderBlogUtil.generateUUID().substring(0,5));
        user.setPassword(newcoderBlogUtil.md5(user.getPassword() + user.getSalt()));
        user.setType(0);
        user.setStatus(0);
        user.setActivationCode(newcoderBlogUtil.generateUUID());
        ...
        //发送的激活链接组成如：http://localhost:8080/newcoderBlog/activation/code
    ...
    public Map<String, Object> login(String username, String password, int expiredSeconds){
        ...
        loginTicket.setTicket(newcoderBlogUtil.generateUUID());
